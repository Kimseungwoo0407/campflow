...
- `2026-08-29`~`2026-08-30`로 잠긴 여행, 실제 장소·주소 검색, 장소 후보, 투표, 일정표
...
장소 검색은 OpenStreetMap Nominatim의 공개 검색 데이터를 사용합니다. 검색 버튼을 눌렀을
때만 요청하며 자동완성은 사용하지 않습니다. 공개 서비스 정책에 맞춰 앱 전체에서 초당 1회
이하로 호출하고 결과를 캐시합니다. 검색 결과의 영업·가격·예약 가능 여부는 후보 등록 전에
원문 링크에서 확인해야 합니다. 자세한 제한과 출처는 [Provider 정책](PROVIDERS.md)에
정리되어 있습니다.
