...
- `2026-08-29`~`2026-08-30`로 잠긴 여행, 지도 링크 기반 직접 장소 후보 등록, 투표, 일정표
...
장소는 앱 내부 검색 결과에서 고르지 않습니다. 사용자가 장소명·위치·거리·가격을 직접
입력해 후보로 등록하며, 장소명과 위치만 필수입니다. 네이버 지도 공유 링크를 함께 저장하면
후보 카드에서 원문 지도를 바로 열어볼 수 있습니다.
